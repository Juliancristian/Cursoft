 ...
 <body>
    ...
    <div class="header-blue">   
    	...
    	<div class="container">
        	...
        	<!-- COLUMNA-->
			<div id="contenedor-finInscripcion" class="col-md-6 col-md-offset-3">
			
				<div class="panel panel-primary">
					<div class="panel-heading">Fin de la Inscripción</div>
							  
					<div class="panel-body">					
			  			<div class="text-panel">Gracias por confiar en Nosotros</div>
			  			<small class="text-muted">Pago con tarjetas de hasta en 12 pagos hace click en el boton Pago Online</small>
			  			
			  			<div class="boton-pagoOnline text-center"><a href="https://www.mercadopago.com.ar/" class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-shopping-cart"></span> Pago Online</a></div>	  					  					  				
					</div>
