		...
		<div class="container">
			...
			<div id="contenedor-formulario-usuario" class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
				...
				<div class="input-group">
					...
					<form:input id="email" class ="form-control" type="email" path="email" placeholder="Ingresar Email" />
	    		</div>			
				<br>
				<!-- INPUT PASSWORD -->
				<div class="input-group">
	      			<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
					<form:input id="password" class ="form-control" type="password" path="password" placeholder="Ingresar Password" />
	    		</div>
				<br>
